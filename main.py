...
from graphics.visualizations import proportions, hospitalization, distribution, correlation, heatmap
...
#%%
proportion = proportions(symptoms, df)
#%%
hospitalizations = hospitalization(df)
#%%
distributions = distribution(df)
#%%
